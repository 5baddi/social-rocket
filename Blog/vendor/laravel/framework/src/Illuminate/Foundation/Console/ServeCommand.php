...
class ServeCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $environmentFile = $this->option('env')
                            ? base_path('.env.local.local').'.'.$this->option('env')
                            : base_path('.env.local.local');
    ...
    protected function getOptions()
    {
        return [
            ...
            ['no-reload', null, InputOption::VALUE_NONE, 'Do not reload the development server on .env.local.local file changes'],
        ];
    }
}
