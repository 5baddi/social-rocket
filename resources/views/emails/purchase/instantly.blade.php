        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td style="width: 120px; text-align: center; padding-right: 5px;">
                        <div style="width: 85%;">
                            <a href="https://twitter.com/intent/tweet?text=You can make money promoting our products!&url={{ $store->domain }}?discount={{ $affiliate->coupon }}" target="_blank" style="text-decoration: none; color: #40ABEE; font-weight: 600; display: inline-block; padding: 8px 15px 8px 12px; background-color: #00af91; border-radius: 30px; cursor: pointer; width: 88%;">
...
<tr>
    <td>
        ...
        <p style="font-size: 14px;">
            Want to get your first sale but don’t know where to start? Check out this epic blog post we wrote on how to make BANK as a brand affiliate: <a href="{{ config('clnkgo.help_url') }}" target="_blank">{{ config('clnkgo.help_url') }}</a>
        </p>
        @endif
