        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td style="width: 120px; text-align: center; padding-right: 5px;">
                        <div style="width: 85%;">
                            <a href="https://twitter.com/intent/tweet?text=You can make money promoting our products!&url={{ $store->domain }}?discount={{ $affiliate->coupon }}" target="_blank" style="text-decoration: none; color: #40ABEE; font-weight: 600; display: inline-block; padding: 8px 15px 8px 12px; background-color: #04AF90; border-radius: 30px; cursor: pointer; width: 88%;">
