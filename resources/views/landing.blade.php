...
<html lang="en">
    ...
    <body>
        ...
        <div class="preview-load-page"></div>
            ...
            <section id="banner">
            <img src="https://d2x5l5rgp1imsp.cloudfront.net/6b57444d-e66e-46f8-92f7-0cf65870724a/home/img/bg-header.png" alt="" class="img-content-header">
            <img src="https://d2x5l5rgp1imsp.cloudfront.net/6b57444d-e66e-46f8-92f7-0cf65870724a/home/img/bg-header-mobile.png" alt="" class="img-content-header-mobile">
            ...
            <div class="container">
                <div class="row row-pricing">
                    <div class="col-content-pricing col-lg-9">
                        ...
                        <div class="list-plans-pricing" id="monthly">
                            ...
                            <div class="item-plan">
                                ...
                                <div class="box-price-item-plan">
                                    <h4 class="title-price-item-plan">{{ $pack->isFixedPrice() ? $pack->symbol : '' }}{{ $pack->amount }}{{ !$pack->isFixedPrice() ? '%' : '' }}</h4>
                        ...
                        <div class="list-plans-pricing" id="yearly" style="display: none" >
                            <div class="item-plan">
                                <h3 class="title-item-plan">Dusting</h3>
                                <div class="box-price-item-plan">
                                    <h4 class="title-price-item-plan">$12</h4>
                                    <div class="text-price-item-plan">
                                        <p>/ per month</p>
                                    </div>
                                </div>
                                <p class="text-discount-item-plan">+ 15% of revenue generated by Social Snowball</p>
                                <div class="separate-line"></div>
                                <ul class="list-benefics-item-plan">
                                    <li>Unlimited affiliates</li>
                                    <li>6 payout methods</li>
                                    <li>Dashboard & data reports</li>
                                    <li>Full customization</li>
                                    <li>Live chat support</li>
                                </ul>
                                <div class="box-btn-item-plan">
                                    <a href="https://socialsnowball.io/connect-store" class="btn-item-plan btn-design1">Start Free Trial</a>
                                </div>
                            </div>
                            <div class="item-plan">
                                <h3 class="title-item-plan">Snow Day <span>Most Popular</span></h3>
                                <div class="box-price-item-plan">
                                    <h4 class="title-price-item-plan">$40</h4>
                                    <div class="text-price-item-plan">
                                        <p>/ per month</p>
                                    </div>
                                </div>
                            ...
                            <div class="item-plan">
                                <h3 class="title-item-plan">Blizzard</h3>
                                <div class="box-price-item-plan">
                                    <h4 class="title-price-item-plan">$75</h4>
                                    <div class="text-price-item-plan">
                                        <p>/ per month</p>
                                    </div>
                                </div>
                                <p class="text-discount-item-plan">+ 5% of revenue generated by Social Snowball</p>
                                <div class="separate-line"></div>
                                <ul class="list-benefics-item-plan">
                                    <li>Unlimited affiliates</li>
                                    <li>6 payout methods</li>
                ...
                <div class="row row-faqs">
                    <div class="col-lg-9 col-content-faqs">
                        ...
                        <div class="items-faqs" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="500" data-aos-delay="100">
                            <div class="item-faq">
                                <button class="btn-item-faq">What is the “Social Snowball effect”? <img src="https://d2x5l5rgp1imsp.cloudfront.net/6b57444d-e66e-46f8-92f7-0cf65870724a/home/img/arrow-down.svg" alt=""></button>
                                <div class="content-item-faq">
                                    <p>
                                        The Social Snowball effect is a tangible application of the “Snowball Effect”, defined by Merriam-Webster as: “a situation in which one action or event causes many other similar actions or events”. The Social Snowball effect involves the event of acquiring a new customer as a catalyst to the acquisition of many new customers. This is accomplished by our custom thank you page, as well as many other included features. To better explain just how powerful the Social Snowball effect is, let's compare and contrast an example store with and without Social Snowball installed:
                                        <br>
                                        ...
                                        <br>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;4. Affiliate revenue generated from the social snowball effect: Unlimited
                                        <br>
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;5. Profit: Unlimited
                                    </p>
                                </div>
                            ...
                            <div class="item-faq">
                                <button class="btn-item-faq">Why is Social Snowball more effective than other affiliate apps? <img src="https://d2x5l5rgp1imsp.cloudfront.net/6b57444d-e66e-46f8-92f7-0cf65870724a/home/img/arrow-down.svg" alt=""></button>
                                <div class="content-item-faq">
        ...
        <footer>
            <img src="https://d2x5l5rgp1imsp.cloudfront.net/6b57444d-e66e-46f8-92f7-0cf65870724a/home/img/bg-footer.svg" alt="" class="bg-footer"/>
            <img src="https://d2x5l5rgp1imsp.cloudfront.net/6b57444d-e66e-46f8-92f7-0cf65870724a/home/img/bg-footer-mobile.svg" alt="" class="bg-footer bg-footer-mobile"/>
            <div class="content-footer">
                ...
                <ul class="links-booter">
                    {{-- <li><a href="https://socialsnowball.zendesk.com/hc/en-us">Contact Us</a></li> --}}
                    {{-- <li><a href="#">FAQ</a></li> --}}
