                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <label class="form-check form-switch">
                                <input name="payout_method" class="form-check-input" type="checkbox" value="bank" @if (old('payout_method') == 'bank')checked @endif/>
                        ...
                        <div class="col-12 mt-2">
                            <label class="form-check form-switch">
                                <input name="notify_new_account" class="form-check-input" type="checkbox" value="paypal" @if (old('payout_method') == 'paypal')checked @endif/>
                                <span class="form-label">
                                    <svg version="1.1" height="24" width="24" class="icon" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        ...
                        <div class="col-12 mt-2">
                            <label class="form-check form-switch">
                                <input name="notify_new_account" class="form-check-input" type="checkbox" value="venmo" @if (old('payout_method') == 'venmo')checked @endif/>
                                <span class="form-label">
                        ...
                        <div class="col-12 mt-2">
                            <label class="form-check form-switch">
                                <input name="notify_new_account" class="form-check-input" type="checkbox" value="zelle" @if (old('payout_method') == 'zelle')checked @endif/>
                                <span class="form-label">
                        ...
                        <div class="col-12 mt-2">
                            <label class="form-check form-switch">
                                <input name="notify_new_account" class="form-check-input" type="checkbox" value="cashapp" @if (old('payout_method') == 'cashapp')checked @endif/>
                                <span class="form-label">
                        ...
                        <div class="col-12 mt-4">
                            <div class="invalid-feedback">{{ $errors->first('payout_method') }}</div>
                        </div>
                        @endif
                    </div>
                    @else
                    <div class="row">
                        <p class="text-muted">Set your email notification presences</p>
                        <div class="col">
                            ...
                            <div class="invalid-feedback">{{ $errors->first('notify_new_account') }}</div>
                            @endif
                        </div>
                        <div class="col">
                            ...
                            <div class="invalid-feedback">{{ $errors->first('notify_new_order') }}</div>
                            @endif
                        </div>
                    </div>
                    @endif
