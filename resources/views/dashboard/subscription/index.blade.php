                        ...
                        <div class="list-plans-pricing" id="monthly">
                            ...
                            <div class="item-plan">
                                ...
                                <div class="box-btn-item-plan @if($currentPack && $currentPack->id === $pack->id) current-plan @endif">
                                    <a href="{{ ($currentPack && $currentPack->id === $pack->id) ? route('dashboard') : route('dashboard.pack.billing', ['pack' => $pack->id]) }}" class="btn-item-plan btn-design1">{{ $currentPack && $currentPack->id === $pack->id ? 'Current Plan' : 'Start Free Trial' }}</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
