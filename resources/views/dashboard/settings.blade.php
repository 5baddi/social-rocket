            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-2">
                            <label class="form-check form-switch">
                                <input name="payout_methods[]" class="form-check-input" type="checkbox" value="zella" @if ((is_array(old('payout_methods')) && in_array('zella', old('payout_methods'))) || (in_array('zella', $setting->payout_methods)))checked @endif/>
                                <span class="form-label">
